...
$indexFile = JPATH_ROOT.'/templates'.DS.$template.'/index.php';
...
$lang_file = JPath::clean(JPATH_ROOT.'/administrator/language'.DS.$lg['tag'].DS.$lg['tag'].'.com_aicontactsafe.ini');
$source_file = JPath::clean(JPATH_ROOT.'/administrator/components/com_aicontactsafe/languages'.DS.$lg['tag'].'.com_aicontactsafe.ini');
...
$lang_file = JPath::clean(JPATH_ROOT.'/administrator/language'.DS.$lg['tag'].DS.$lg['tag'].'.com_aicontactsafe.menu.ini');
$source_file = JPath::clean(JPATH_ROOT.'/administrator/components/com_aicontactsafe/languages'.DS.$lg['tag'].'.com_aicontactsafe.menu.ini');
if (is_file($lang_file)) {
if (is_file($source_file)) {
JFile::delete($lang_file);
JFile::copy($source_file, $lang_file);
...
$lang_file = JPath::clean(JPATH_ROOT.'/administrator/language'.DS.$lg['tag'].DS.$lg['tag'].'.com_aicontactsafe.sys.ini');
$source_file = JPath::clean(JPATH_ROOT.'/administrator/components/com_aicontactsafe/languages'.DS.$lg['tag'].'.com_aicontactsafe.sys.ini');
if (is_file($lang_file)) {
if (is_file($source_file)) {
JFile::delete($lang_file);
JFile::copy($source_file, $lang_file);
...
foreach($languages as $lg) {
$lang_file = JPath::clean(JPATH_ROOT.'/language'.DS.$lg['tag'].DS.$lg['tag'].'.com_aicontactsafe.ini');
$source_file = JPath::clean(JPATH_ROOT.'/components/com_aicontactsafe/languages'.DS.$lg['tag'].'.com_aicontactsafe.ini');
if (is_file($lang_file)) {
if (is_file($source_file)) {
JFile::delete($lang_file);
JFile::copy($source_file, $lang_file);
...
$return = 0;
$xml_file ='modules/mod_aicontactsafe/mod_aicontactsafe.xml';
if (is_file($xml_file)) {
$xml = new SimpleXMLElement( $xml_file );

$version = $xml->document->getElementByPath( 'version' );
$installed_version = $version->data();
$xml_file = 'administrator/components/com_aicontactsafe/includes/mod_aicontactsafe/mod_aicontactsafe.xml';
if (is_file($xml_file)) {
$xml = new SimpleXMLElement( $xml_file );
$version = $xml->document->getElementByPath( 'version' );
...
$return = 0;
if(version_compare(JVERSION, '1.6.0', 'ge')) {
$xml_file = 'plugins/content/aicontactsafeform/aicontactsafeform.xml';
} else {
$xml_file = 'plugins/content/aicontactsafeform.xml';
}
if (is_file($xml_file)) {
$xml = new SimpleXMLElement( $xml_file );
$version = $xml->document->getElementByPath( 'version' );
$installed_version = $version->data();
$xml_file = 'administrator/components/com_aicontactsafe/includes/plg_aicontactsafeform/aicontactsafeform.xml';
if (is_file($xml_file)) {
$xml = new SimpleXMLElement( $xml_file );
$version = $xml->document->getElementByPath( 'version' );
$current_version = $version->data();
...
$return = 0;
if(version_compare(JVERSION, '1.6.0', 'ge')) {
$xml_file = 'plugins/content/aicontactsafelink/aicontactsafelink.xml';
} else {
$xml_file = 'plugins/content/aicontactsafelink.xml';
}
if (is_file($xml_file)) {
$xml = new SimpleXMLElement( $xml_file );
$version = $xml->document->getElementByPath( 'version' );
$installed_version = $version->data();
$xml_file = 'administrator/components/com_aicontactsafe/includes/plg_aicontactsafelink/aicontactsafelink.xml';
if (is_file($xml_file)) {
$xml = new SimpleXMLElement( $xml_file );
$version = $xml->document->getElementByPath( 'version' );
$current_version = $version->data();
